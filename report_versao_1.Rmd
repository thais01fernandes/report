...
dados_respondentes <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1Zydeu1lZf6rzGeZ3byB_I23TFw9FPqZHn3yYI0LIP_E/edit#gid=0", sheet = 2) %>% 
  janitor::clean_names()


dados_completos <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1Zydeu1lZf6rzGeZ3byB_I23TFw9FPqZHn3yYI0LIP_E/edit#gid=0", sheet = 3) 
...
tabela_cargo_outros <- dados_respondentes %>%  
  mutate(outro_cargo = case_when(outro_cargo == "Auxiliar de serviços Gerais" ~ "Auxiliar de serviços gerais", 
                                 outro_cargo == "Farmácia" ~ "Farmacêutico",
                                 outro_cargo == "Analista de planejamento e logística opme" ~ "Analista de planejamento e logística",
                                 outro_cargo == "Assiste de atendimento" ~ "Assistente de atendimento",
                                 outro_cargo == "assistente de atendimento" ~ "Assistente de atendimento",
                                 outro_cargo == "Assistente" ~ "Assistente",
                                 outro_cargo == "Assistente de atendimento 2" ~ "Assistente de Atendimento II",
                                 outro_cargo == "Assistente de atendimento II" ~ "Assistente de Atendimento II",
                                 outro_cargo == "técnico de enfermagem" ~ "Técnico de enfermagem",
                                 outro_cargo == "Técnico em enfermagem" ~ "Técnico de enfermagem",
                                 outro_cargo == "Auxiliar de nutrição" ~ "Auxiliar de Nutrição",
                                 outro_cargo == "Administração" ~ "Administrativo",
                                 outro_cargo == "Nutrição" ~ "Nutricionista",
                                 outro_cargo == "Analista de faturas" ~ "Faturamento",
                                 outro_cargo == "BIOMÉDICA" ~ "Biomédico",
                                 outro_cargo == "Biomedico" ~ "Biomédico",
                                 outro_cargo == "Recepcionista" ~ "Recepção",
                                 outro_cargo == "Auxiliar farmácia" ~ "Auxiliar de Farmácia",
                                 outro_cargo == "𝔸𝕦𝕩𝕚𝕝𝕚𝕒𝕣 𝕕𝕖 𝕗𝕒𝕣𝕞𝕒́𝕔𝕚𝕒" ~ "Auxiliar de Farmácia",
                                 outro_cargo == "Aux de farmácia" ~ "Auxiliar de Farmácia",
                                 outro_cargo == "Auxiliar de farmacia" ~ "Auxiliar de Farmácia",
                                 outro_cargo == "auxiliar de farmácia" ~ "Auxiliar de Farmácia",
                                 outro_cargo == "Portaria (segurança)" ~ "Portaria",
                                 outro_cargo == "Analista de laboratório pleno" ~ "Analista de laboratório",
                                 outro_cargo == "Recepção internação" ~ "Recepção de internação",
                                 outro_cargo == "Recepcionista internação" ~ "Recepção de internação",
                                 outro_cargo == "Recepcionista pronto socorro" ~ "Recepção Pronto socorro",
                                 outro_cargo == "jovem aprendiz" ~ "Jovem aprendiz",
                                 outro_cargo == "Assistente administrativo" ~ "Assistente Administrativo",
                                 outro_cargo == "assistente administrativo" ~ "Assistente Administrativo",
                                 outro_cargo == "Auxiliar de cozinha" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Auxiliar de copa" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Aux ser gerais" ~ "Auxiliar de serviços gerais",
                                 outro_cargo == "Bombeiro Civil" ~ "Bombeiro",
                                 outro_cargo == "Técnico farmácia" ~ "Técnico de farmácia",
                                 outro_cargo == "RECEPCIONISTA" ~ "Recepção",
                                 outro_cargo == "Biomédica" ~ "Biomédico",
                                 outro_cargo == "RECEPÇÃO" ~ "Recepção",
                                 outro_cargo == "Faturista" ~ "Faturamento",
                                 outro_cargo == "faturamento" ~ "Faturamento",
                                 outro_cargo == "Instrumentadora" ~ "Instrumentador Cirurgico",
                                 outro_cargo == "Instrumentador cirúrgico" ~ "Instrumentador Cirurgico",
                                 outro_cargo == "Instrumentadora Cirúrgica" ~ "Instrumentador Cirurgico",
                                 outro_cargo == "Instrumentadora cirúrgica" ~ "Instrumentador Cirurgico",
                                  outro_cargo == "Intrumentadora" ~ "Instrumentador Cirurgico",
                                 outro_cargo == "Administrativo Plano" ~ "Administrativo Plano de Saúde",
                                 outro_cargo == "Analista de Faturamento" ~ "Auxiliar de faturamento",
                                 outro_cargo == "Emissão de guias" ~ "Emissão de guias / setor administrativo",
                                 outro_cargo == "Emissão de  guias / setor administrativo" ~ "Emissão de guias / setor administrativo",
                                 outro_cargo == "t.i" ~ "TI",
                                 outro_cargo == "Analista de faturamento" ~ "Analista de Faturamento",
                                 outro_cargo == "Higienização" ~ "Higiene",
                                 outro_cargo == "Tec controle de leitos" ~ "Técnico Controle de Leitos",
                                 outro_cargo == "Técnico controle de leitos" ~ "Técnico Controle de Leitos",
                                 outro_cargo == "Técnico de controle de leitos" ~ "Técnico Controle de Leitos",
                                 outro_cargo == "Aux faturamento" ~ "Auxiliar de faturamento",
                                 outro_cargo == "Auxiliar de nutrição" ~ "Auxiliar de Nutrição",
                                 outro_cargo == "AUXILIAR COZINHA" ~ "Auxiliar de cozinha",
                                 outro_cargo == "Auxiliar administrativo" ~ "Auxiliar Administrativo",
                                 outro_cargo == "Técnica Administrativa" ~ "Técnico Administrativo",
                                 outro_cargo == "Tecnico Administrativo" ~ "Técnico Administrativo",
                                 outro_cargo == "Tecnico Administrativo" ~ "Técnico Administrativo",
                                 outro_cargo == "Técnico administrativo" ~ "Técnico Administrativo",
                                 outro_cargo == "Técnico de Administrativo" ~ "Técnico Administrativo",
                                 outro_cargo == "tecnico administrativo" ~ "Técnico Administrativo",
                                 outro_cargo == "técnico adm." ~ "Técnico Administrativo",
                                  outro_cargo == "técnico administrativi" ~ "Técnico Administrativo",
                                 outro_cargo == "Tecnico ADM" ~ "Auxiliar Administrativo",
                                 outro_cargo == "Higienização" ~ "Higiene",
                                 outro_cargo == "Auxiliar de nutrição" ~ "Auxiliar de Nutrição",
                                 outro_cargo == "AUXILIAR COZINHA" ~ "Auxiliar de cozinha",
                                 outro_cargo == "Auxiliar administrativo" ~ "Auxiliar Administrativo",
                                 outro_cargo == "Aux administrativo" ~ "Auxiliar Administrativo",
                                 outro_cargo == "Administrativo/escritório" ~ "Administrativo",
                                 outro_cargo == "Higenizacao" ~ "Higiene",
                                 outro_cargo == "Auxiliar de copa e cozinha." ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Farmacia" ~ "Farmácia",
                                 outro_cargo == "Copa" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Auxiliar de cozinha,, nutrição" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Auxiliar de cozinha,, nutrição" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Auxiliar de cozinha" ~ "Auxiliar de copa e cozinha",
                                 outro_cargo == "Auxiliar lavandeira" ~ "Auxiliar de lavandeira",
                                 outro_cargo == "Jovem aprendiz." ~ "Jovem Aprendiz",
                                 outro_cargo == "Aprendiz" ~ "Jovem Aprendiz",
                                 outro_cargo == "Motorista" ~ "Condutor",
                                 ...
                                 outro_cargo == "cozinheiro" ~ "Cozinheiro",
                                 outro_cargo == "SEGURANÇA" ~ "Segurança",
...
tabela_area_outros <- dados_respondentes %>%  
  mutate(outra_area = case_when(outra_area == "Copeira" ~ "Copa", 
                                outra_area == "Qualidade" ~ "Qualidade, Segurança, Scih e Melhoria", 
                                outra_area == "SCIH" ~ "SCIH - Serviço de Controle de Infecção Hospitalar",
                                outra_area == "Tecnologia da Informação" ~ "TI", 
                                outra_area == "Medicina Diagnóstico" ~ "Medicina Diagnóstica",
                                outra_area == "Medicina diagnóstica" ~ "Medicina Diagnóstica",
                                outra_area == "Abrir ficha para o paciente passar com o médico" ~ "Recepção",
                                outra_area == "Atendimento no balcão, fazer internação, recepcionar o paciente" ~ "Recepção",
                                outra_area == "laboratório" ~ "Laboratório",
                                outra_area == "Higiêne" ~ "Higiene",
                                outra_area == "Higiêne" ~ "Higiene",
                                outra_area == "Einstein até voce" ~ "Einstein Até Você",
                                outra_area == "oncologia" ~ "Oncologia",
                                outra_area == "Hospital Santa Catarina - Oncologia" ~ "Oncologia",
                                outra_area == "Faturista" ~ "Faturamento",
                                outra_area == "Pronto socorro" ~ "Pronto Socorro",
                                outra_area == "PS" ~ "Pronto Socorro",
                                outra_area == "Ps" ~ "Pronto Socorro",
                                outra_area == "uti a" ~ "UTI",
                                outra_area == "Uti" ~ "UTI",
                                outra_area == "Uti adulto" ~ "UTI",
                                outra_area == "RECEPÇÃO" ~ "Recepção",
                                outra_area == "Internacao" ~ "Internação",
                                outra_area == "Área de apoio, farmácia" ~ "Farmácia", 
                                outra_area == "Farmacêutica" ~ "Farmácia", 
                                outra_area == "Setor de Internação oncologia" ~ "Internação oncologia", 
                                outra_area == "FARMACIA" ~ "Farmácia",
                                outra_area == "Mda" ~ "MDA",
                                outra_area == "Farmácia Central" ~ "Farmácia",
                                outra_area == "Farmácia central" ~ "Farmácia",
                                outra_area == "Recepção, auxiliar de sala" ~ "Recepção/auxiliar de sala/ultrassom", 
                                outra_area == "Uti neonatal" ~ "Uti neo e centro obstétrico",
                                outra_area == "Copeiro" ~ "Copa",
                                outra_area == "Centro de diagnóstico de imagem" ~ "Centro de Diagnóstico por Imagem",
                                outra_area == "Saude mental" ~ "Saúde mental",
                                outra_area == "Diagnóstico por imagens" ~ "Centro de Diagnóstico por Imagem",
                                outra_area == "Área de apoio, farmácia" ~ "Farmácia", 
                                outra_area == "farmacia" ~ "Farmácia", 
                                outra_area == "Farmacia" ~ "Farmácia",
                                outra_area == "farmacia central" ~ "Farmácia",
                                outra_area == "farmacia upa vila santa catarina" ~ "Farmácia",
                                outra_area == "farmácia da upa" ~ "Farmácia",
                                outra_area == "𝕋𝕣𝕒𝕝𝕙𝕠 𝕟𝕠 𝕙𝕠𝕤𝕡𝕚𝕥𝕒𝕝 𝕊𝕒𝕟𝕥𝕒 ℂ𝕒𝕥𝕒𝕣𝕚𝕟𝕒 𝕗𝕒𝕣𝕞𝕒́𝕔𝕚𝕒/𝕌𝕡𝕒" ~ "Farmácia",
                                outra_area == "Copeiro" ~ "Copa",
                                outra_area == "UTI A" ~ "UTI",
                                outra_area == "UTI A" ~ "UTI",
                                outra_area == "UTI ADULTO" ~ "UTI",
                                outra_area == "UTI Adulto" ~ "UTI",
                                outra_area == "UNIDADE DE PRONTO ATENDIMENTO" ~ "Upa",
                                outra_area == "Unidade de Pronto Atendimento" ~ "Upa",
                                outra_area == "Pronto atendimento" ~ "Upa",
                                outra_area == "Upa VILA Santa Catarina" ~ "Upa",
                                outra_area == "Upa vila Santa Catarina" ~ "Upa",
                                outra_area == "Vários departamentos da UPA" ~ "Upa",
                                outra_area == "UPA vsc" ~ "Upa",
                                outra_area == "UPA VILA Santa Catarina" ~ "Upa",
                                outra_area == "Unidade de Pronto Atendimento UPA" ~ "Upa",
                                outra_area == "Unidade de pronto atendimento" ~ "Upa",
                                outra_area == "Ambulatório de Oncologia ." ~ "Ambulatório de Oncologia",
                                outra_area == "Ambulatório de oncologia" ~ "Ambulatório de Oncologia",
                                outra_area == "Saude mental" ~ "Saúde mental",
                                outra_area == "endoscopia" ~ "Endoscopia",
                                outra_area == "Unidade Saúde Mental Adulto" ~ "Saúde mental",
                                outra_area == "BANCO DE SANGUE" ~ "Banco de sangue",
                                outra_area == "banco de sangue" ~ "Banco de sangue",
                                outra_area == "banco  de sangue" ~ "Banco de sangue",
                                outra_area == "laboratorio" ~ "Laboratório",
                                outra_area == "Laboratório de análises clínicas" ~ "Laboratório",
                                outra_area == "Cuidador de idosos" ~ "Cuidado ao Idoso",
                                outra_area == "Cirurgia" ~ "Centro cirúrgico",
                                outra_area == "centro cirurgico" ~ "Centro cirúrgico",
                                outra_area == "Engenharia Clinica" ~ "Engenharia Clínica",
                                outra_area == "engenharia clinica" ~ "Engenharia Clínica",
                                outra_area == "Lavandeira" ~ "Lavanderia",
                                outra_area == "Diagnostico" ~ "Setor de Diagnóstico",
                                outra_area == "Setor de diagnóstico" ~ "Setor de Diagnóstico",
                                outra_area == "Diagnóstico pôr imagem" ~ "Diagnóstico por imagem",
                                outra_area == "inagem" ~ "Diagnóstico por imagem",
                                outra_area == "setor imagem" ~ "Diagnóstico por imagem",
                                outra_area == "Exames diagnóstico de imagem" ~ "Diagnóstico por imagem",
                                outra_area == "Exames diagnósticos de imagem" ~ "Diagnóstico por imagem",
                                outra_area == "Setor Emergência" ~ "Urgência e emergência",
                                outra_area == "rede de urgência e emergência (UPA e SAMU)" ~ "Urgência e emergência",
                                outra_area == "Setor de diagnóstico por imagem. Onde também vamos em outras unidades realizar exames.ex: RX de tórax leito em unidade clínica" ~ "Diagnóstico por imagem",
                                ...
                                outra_area == "Higienização de ambientes" ~ "Higiene",
                                outra_area == "Limpeza" ~ "Higiene",
                                ...
                                outra_area == "Imagem" ~ "Diagnóstico por imagem",
                                ...
                                outra_area == "Melhor em casa"  ~ "Melhor em Casa",
                                outra_area == "Melhor em Casa - EMAD"  ~ "Melhor em Casa",
                                outra_area == "vila santa catarina"  ~ "Hospital Vila Santa Catarina",
                                outra_area == "Central de diluição de  medicamentos"  ~ "Central de diluição de medicamentos",
                                outra_area == "UPA" ~ "Upa",
                                outra_area == "Oncológico" ~ "Oncologia",
                                outra_area == "Setor da imagem" ~ "Diagnóstico por imagem",
                                outra_area == "Serviço de imagem" ~ "Diagnóstico por imagem",
                                outra_area == "Internação" ~ "Unidade de internação", 
                                TRUE ~ (outra_area))) %>%
  group_by(outra_area) %>% 
...
grafico_1 <- dados_completos %>% 
  ...
  geom_bar(width = 3, stat = "identity") +  # width = 1 para preencher completamente as barras
 ...
 ggsave("grafico_1.png", plot = grafico_1, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_2 <- dados_completos %>% 
 ...
 ggsave("grafico_2.png", plot = grafico_2, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_3 <- dados_completos %>% 
 ...
 ggsave("grafico_3.png", plot = grafico_3, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_4 <- dados_completos %>% 
 ...
 ggsave("grafico_4.png", plot = grafico_4, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_5.png", plot = grafico_5, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_6 <- dados_completos %>% 
 ...
 ggsave("grafico_6.png", plot = grafico_6, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_7 <- dados_completos %>% 
 ...
 ggsave("grafico_7.png", plot = grafico_7, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_8.png", plot = grafico_8, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_9 <- dados_completos %>% 
 ...
 ggsave("grafico_9.png", plot = grafico_9, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_9_1 <- dados_completos %>% 
 ...
 ggsave("rafico_9_1.png", plot = grafico_9_1, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_dez <- dados_completos %>% 
 ...
 ggsave("grafico_dez.png", plot = grafico_dez, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_onze.png", plot = grafico_onze, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_doze <- dados_completos %>% 
 ...
 ggsave("grafico_doze.png", plot = grafico_doze, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_treze.png", plot = grafico_treze, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_catorze <- dados_completos %>% 
 ...
 ggsave("grafico_catorze.png", plot = grafico_catorze, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_quinze <- dados_completos %>% 
 ...
 ggsave("grafico_quinze.png", plot = grafico_quinze, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_dezesseis.png", plot = grafico_dezesseis, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_dezessete <- dados_completos %>% 
 ...
 ggsave("grafico_dezessete.png", plot = grafico_dezessete, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_dezoito <- dados_completos %>% 
 ...
 ggsave("grafico_dezoito.png", plot = grafico_dezoito, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_dezenove.png", plot = grafico_dezenove, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte <- dados_completos %>% 
 ...
 ggsave("grafico_vinte.png", plot = grafico_vinte, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_um <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_um.png", plot = grafico_vinte_um, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_vinte_dois.png", plot = grafico_vinte_dois, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_tres <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_tres.png", plot = grafico_vinte_tres, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_quatro <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_quatro.png", plot = grafico_vinte_quatro, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_cinco <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_cinco.png", plot = grafico_vinte_cinco, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_vinte_seis.png", plot = grafico_vinte_seis, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_sete <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_sete.png", plot = grafico_vinte_sete, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_vinte_oito <- dados_completos %>% 
 ...
 ggsave("grafico_vinte_oito.png", plot = grafico_vinte_oito, width = 8, height = 0.5, units = "in", dpi = 400) 
...
filter(pergunta_2 != "N/a") %>% 
 ...
 ggsave("grafico_vinte_nove.png", plot = grafico_vinte_nove, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_trinta <- dados_completos %>% 
 ...
 ggsave("grafico_trinta.png", plot = grafico_trinta, width = 8, height = 0.5, units = "in", dpi = 400) 
...
grafico_trinta_um <- dados_completos %>% 
 ...
 ggsave("grafico_trinta_um.png", plot = grafico_trinta_um, width = 8, height = 0.5, units = "in", dpi = 400) 
